                    ...
                    <Row>
                        <Col className="col-12 d-flex align-items-center itemView">
                            ...
                            <span className="shortcuts">
                                <a href={`https://impress.openneo.net/items?utf8=%E2%9C%93&q=${item.name}`} target="_blank"><Image src="https://wakaguide.com/images/dti.png" /></a>
                                <a href={`https://impress-2020.openneo.net/items/search/${item.name}`} target="_blank"><Image src="https://wakaguide.com/images/2020dti.png" /></a>
                                <a href={`https://items.jellyneo.net/search/?name=${item.name}&name_type=1`} target="_blank"><Image src="https://wakaguide.com/images/jn.png" /></a>
                            </span>
                        </Col>
